<template>
    <div>
        ...
        font-size: 1.3em; font-weight: nomal;" @click="goMypageView">예매관리</button>
                    <div class="vr" style="background-color: #FF8551;  opacity: 1;"></div>
                    <button style="width:120px; height:25px; border:1px; background-color:rgba(0,0,0,0);
        ...
        <div class="row">
            ...
            <div class="row2"  style = "width:20%;height:600px; background-color :#FFFAF8;" >
            ...
            <div class="row2"  style = "width:5%;height:600px; background-color:#FFFAF8;" >

                <!-- 세로줄 -->
                <div style="width:75%; height:600px; borde:1px; float:left;">
                    <div class="d-flex" style="height: 600px;  z-index: 1; border-color: #FF8551; " >
                        <div class="vr" style="background-color: #FF8551;  opacity: 1;"></div>
            ...
            <div class="row2"  style = "width:45%;height:600px; background-color:#FFFAF8;" >
                <div style="width:100%; height:100%; border:1px; float:left; padding:10px;">
                    <br>
                    ...
                    <form @submit="changePassword">
                        ...
                        <button v-if="changePasswordFormVisible" type="submit" style="font-size:20px; padding:6px 45px 6px 45px; background-color: #FFE2C0; border-radius: 10px;  border:1px solid black;" @click="updatePassword" >수정</button>
                        <div class="hello"></div>
