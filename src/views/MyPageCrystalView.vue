<template>
    <div class="container">
      ...
      font-size: 1.3em; font-weight: nomal">예매관리</button>
                <div class="vr"></div>
                <button style="width:120px; height:50px; border:1px; background-color:rgba(0,0,0,0);
    ...
    <div class="row">
        ...
        <div class="row2"  style = "width:45%;height:800px; background-color:gray;" >
            <div style="width:100%; height:100%; border:1px; float:left; padding:10px;">
                <br>
                <div style="width:100% height:220px; border:1px; text-align:left; font-size: 18px;">이름이 표시됩니다.</div>
                <hr>
                <div style="width:100% height:250px; border:1px; text-align:left; font-size: 18px;">생년월일이 표시됩니다.</div>
                <hr>
                <div style="width:100% height:250px; border:1px; text-align:left; font-size: 18px;">휴대전화번호가 표시됩니다.
                    <button type="button" class="btn btn-outline-light" style="float:right">전화번호 변경</button></div>
                <hr>
                <div style="width:100% height:250px; border:1px; text-align:left; font-size: 18px;">이메일이 표시됩니다.</div>
                <hr>
